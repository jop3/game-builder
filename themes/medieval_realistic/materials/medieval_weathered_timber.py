"""themes/medieval_realistic/materials/medieval_weathered_timber -- grey,
heavily weathered structural timber, sampled from ``secondary`` (spec 10.2).
"""
...
PARAM_SCHEMA = {
    "type": "object",
    "properties": {
        "ring_scale": {"type": "number", "minimum": 8.0, "maximum": 25.0, "default": 14.0},
        "roughness": {"type": "number", "minimum": 0.5, "maximum": 0.9, "default": 0.75},
    },
...
def build(nt, params: dict, rng, palette_dict: dict) -> None:
    ...
    ra, ga, ba = palette.sample_palette_color(palette_dict, "secondary", rng)
